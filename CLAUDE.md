...
Color Challenge is a Minecraft mod where players compete to earn 10,000 gold by mining and selling ores to an NPC staff. Built with **Architectury** for cross-platform support (Fabric + NeoForge/Forge), targeting Minecraft 1.21.9, 1.21.8, 1.21.7, 1.21.6, 1.21.5, 1.21.4, 1.21.3, 1.21.1 (Java 21) and 1.20.1 (Java 17).
