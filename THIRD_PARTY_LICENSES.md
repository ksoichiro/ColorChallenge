...
This document lists all third-party dependencies used in Color Challenge and their respective licenses.
...
- Runtime dependencies are not bundled with Color Challenge; users must install them separately
- NeoForge's LGPL-2.1 license does not affect Color Challenge's license due to linking exception
- Architectury API's LGPL-3.0 license does not affect Color Challenge's license due to linking exception

## License Compliance

Color Challenge is licensed under the LGPL-3.0-only License. All dependencies are compatible with this license:
