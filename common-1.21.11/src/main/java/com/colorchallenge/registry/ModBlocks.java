...
public class ModBlocks {
    ...
    public static Block createGameStartBlock() {
        return new GameStartBlock(BlockBehaviour.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK,
                        Identifier.fromNamespaceAndPath(ColorChallenge.MOD_ID, "game_start_block")))
                .strength(5.0F, 6.0F));
    }
    ...
    public static Block createGameResetBlock() {
        return new GameResetBlock(BlockBehaviour.Properties.of()
                .setId(ResourceKey.create(Registries.BLOCK,
                        Identifier.fromNamespaceAndPath(ColorChallenge.MOD_ID, "game_reset_block")))
                .strength(5.0F, 6.0F));
    }
    ...
    public static Item createBlockItem(Block block) {
        ...
        return new BlockItem(block, new Item.Properties()
                .setId(ResourceKey.create(Registries.ITEM,
                        Identifier.fromNamespaceAndPath(ColorChallenge.MOD_ID, blockName)))
