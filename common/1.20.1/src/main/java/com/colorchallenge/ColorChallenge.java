...
public class ColorChallenge {
    ...
    public static boolean onInteractEntity(net.minecraft.world.entity.player.Player player,
        ...
        offers.add(new MerchantOffer(
                new ItemStack(Items.EMERALD, 1), new ItemStack(Items.JUNGLE_SAPLING), 16, 1, 0.05f));
        offers.add(new MerchantOffer(
                new ItemStack(Items.EMERALD, 1), new ItemStack(Items.CACTUS), 16, 1, 0.05f));
        offers.add(new MerchantOffer(
                new ItemStack(Items.EMERALD, 1), new ItemStack(Items.SEA_PICKLE), 16, 1, 0.05f));
