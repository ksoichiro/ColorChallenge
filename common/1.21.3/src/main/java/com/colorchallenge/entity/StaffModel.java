...
public class StaffModel extends EntityModel<StaffRenderState> {
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ColorChallenge.MOD_ID, "staff"), "main");
    ...
    @Override
    public void setupAnim(StaffRenderState state) {
